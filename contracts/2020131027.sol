...
contract Uniswap is FT {
    ...
    constructor(address _token0, address _token1) FT("Uni", "U") {
        token0 = _token0;
        token1 = _token1;
    }
    ...
    // fee _charge
    function _Charge(uint256 total) internal pure returns (uint256) {
